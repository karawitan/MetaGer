...
return [
	...
	'testimonials' => [
		'"Thank you for creating metager."',
		'"I (85 years old) would like to donate 200 Euros for your laborious work. Stay strong against the krakens."',
		'"I consider your work very valuable"',
		'"Thank you for your good work!"',
		'"Great, the new MetaGer!"',
		'"A search engine developed and operated by you is very welcome. My donation for it"',
		'"As a small contribution for your great and grandiose work, I donate"',
		'"Please debit 100,-EUR for your good work."',
		'"Especially in these times, we need a search engine from safe hands with good intentions."',
		'"Your work is top-notch. That is why I want to support your project."',
		'"I have been using Metager for years and thank you with a donation"',
		'"MetaGer is great! I donate"',
		'"Poor pensioner gladly donates 5.00 Euros"',
		'"I almost exclusively use the MetaGer search and am very satisfied with it"',
